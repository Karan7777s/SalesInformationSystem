...
namespace SalesInformationSystem.Data.Migrations
{
    ...
    [Migration("20250523043216_addedCartItemsModel")]
    partial class addedCartItemsModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.CartItems", b =>
                {
                    b.Property<int>("CartPk")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CartPk"));
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProductDescriptiion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.Quotation", b =>
                {
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.QuotationItem", b =>
                {
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.SalesOrder", b =>
                {
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.CartItems", b =>
                {
                    b.HasOne("SalesInformationSystem.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("SalesInformationSystem.Models.QuotationItem", b =>
                {
                    ...
                    b.HasOne("SalesInformationSystem.Models.Quotation", "Quotation")
                        .WithMany()
