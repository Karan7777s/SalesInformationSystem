...
namespace SalesInformationSystem.Controllers
{
    public class QuotationItemsController : Controller
    {
        ...
        // GET: Quotations
        public async Task<IActionResult> GetCustQuotations(int custId)
        {
            ViewBag.custId = custId;

            ViewBag.cutomer =_context.Customer.Where
                (c => c.CustomerId == custId).FirstOrDefault().CustFname;
            return View(await _context.Quotation.Where
